...
if __name__ == '__main__':
    ...
    ckpt_cb = ModelCheckpoint(dirpath=f'ckpts/NGP/{hparams.dataset_name}/{hparams.exp_name}',
                              filename='{epoch:d}',
    ...
    logger = TensorBoardLogger(save_dir=f"logs/NGP/{hparams.dataset_name}",
    ...
    if not hparams.val_only: # save slimmed ckpt for the last epoch
        ckpt_ = \
            slim_ckpt(f'ckpts/NGP/{hparams.dataset_name}/{hparams.exp_name}/epoch={hparams.num_epochs-1}.ckpt',
                      save_poses=hparams.optimize_ext)
        torch.save(ckpt_, f'ckpts/NGP/{hparams.dataset_name}/{hparams.exp_name}/epoch={hparams.num_epochs-1}_slim.ckpt')
